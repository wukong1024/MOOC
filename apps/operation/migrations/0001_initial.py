# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2019-11-02 18:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='courses.Course', verbose_name='课程名称')),
            ],
            options={
                'verbose_name': '用户咨询',
